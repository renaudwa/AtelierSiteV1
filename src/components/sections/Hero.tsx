...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center animated-gradient overflow-hidden pt-16">
      ...
      <div className="container mx-auto px-4 md:px-6 py-12 flex flex-col md:flex-row items-stretch z-10">
        <div className="md:w-1/2 mb-12 md:mb-0 md:pr-8 flex flex-col justify-center">
          <h1 
            ref={headingRef}
          ...
          <button
            ref={buttonRef}
            className="btn-3d bg-gradient-to-r from-vcube-orange to-vcube-teal text-white px-8 py-4 rounded-lg font-semibold text-lg opacity-0"
            style={{ transition: 'all 0.3s ease-out' }}
          >
        ...
        <div 
          ...
          className="md:w-1/2 opacity-0 h-[600px] md:h-auto flex items-center justify-center"
          style={{ 
